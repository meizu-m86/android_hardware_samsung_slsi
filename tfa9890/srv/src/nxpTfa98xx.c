 ...
 * module globals
 */
extern int tfaRun_StatusWait(Tfa98xx_handle_t handle, unsigned short bitmask,int value, int maxTries);
extern void Tfa98xx_ConvertBytes2Data(int num_bytes, const unsigned char bytes[], int data[]);
extern void Tfa98xx_ConvertData2Bytes(int num_data, const int data[], unsigned char bytes[]);
