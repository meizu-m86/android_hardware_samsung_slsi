...
#endif //LPCDEMO
extern _Bool i2c_Read(int bus, int addr, void* data, int size, int* nr);
extern _Bool i2c_Write(int bus, int addrWr, void* dataWr, int sizeWr);
extern int i2c_WriteRead(int bus, int addrWr, void* dataWr, int sizeWr, int* nWr, void* dataRd, int sizeRd, int* nRd);
extern int i2c_GetSpeed(int bus);
extern void i2c_SetSpeed(int bus, int bitrate);
extern _Bool gui_GetValue(menuElement_t item, int* val);
extern _Bool gui_SetValue(menuElement_t item, int* val);
#define CMDSIZE 300
#define LOGERR 1
